           ...
           <tbody>
            <?php  foreach($datalist as $data):  ?>
                    <tr>
                        ...
                        <td class="last"><a href="annonce-details-<?php echo $data->getId() ?>.html">Détails</a> <a href="annonce-edit-<?php echo $data->getId() ?>.html"><img src="../Themes/backend/backend_images/edit-icon.gif" style="width:16px; height:16px;" alt="&Eacute;diter" /></a> <a href="annonce-delete-<?php echo $data->getId() ?>.html" onclick="return(confirm('Êtes-vous sûr?'));"><img src="../Themes/backend/backend_images/hr.gif" style="width:16px; height:16px;" alt="Supprimer" /></a></td>
                    </tr>             
