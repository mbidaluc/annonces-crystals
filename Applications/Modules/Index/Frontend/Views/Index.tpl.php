...
<ul id ="category_home" class="clearfix">
    ...
    <li class="item <?php echo $class; ?>">
        ...
        <div class="c_img_cat">
            <a class="wrap_img_cat" href="<?php echo $tools->getLinkCategory($data);?>" title="<?php echo $data->getLibelle();?>">
                <img src="<?php echo $tools->getLinkImage('Categories','cat',$data->getImage(),$paramsconf[0]->getDefaultCategoryImage());?>" alt="<?php echo $data->getLibelle();?>" />
            </a>
        </div>
