       ...
       <tbody>
        <?php  foreach($datalist as $data):  ?>
                <tr>
                    ...
                    <td><img alt="<?php echo $data->getNom()  ?>" src="<?php echo _UPLOAD_DIR_.'PaiementMod/'.array_shift(explode(';',$data->getLogo()))  ?>" width="100"/></td>
                    <td class="first style1"><?php echo $data->getNom() ?></td>   
                    <td ><?php echo $data->getIs_actived() ?></td>
                    <td class="last"><a href="modepaiement-edit-<?php echo $data->getId() ?>.html"><img src="../Themes/backend/backend_images/edit-icon.gif" style="width:16px; height:16px;" alt="&Eacute;diter" /></a> <a href="modepaiement-delete-<?php echo $data->getId() ?>.html" onclick="return(confirm('Êtes-vous sûr?'));"><img src="../Themes/backend/backend_images/hr.gif" style="width:16px; height:16px;" alt="Supprimer" /></a></td>
                </tr>             
