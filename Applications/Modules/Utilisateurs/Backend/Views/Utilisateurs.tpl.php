<div class="top-bar">
    <a href="add-user.html" class="button">ADD NEW</a>
    <h1>Gestion des utilisateur</h1>
    <div class="breadcrumbs"><a href="user.html">Utilsateur</a> / Liste</div>
</div><br />
...
<form name="" action="actiongroupeduser.html" method="post" id="groupaction">
    ...
    <div class="table">
     ...
     <input type="hidden" name="actiontodo" value="./actiongroupeduser.html" id="actiontodo" />
</form>
