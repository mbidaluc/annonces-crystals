( function($) { 
    $(document).ready(function(){
        ...
        $('#toolsbar').on('click','#checkall',function(event){
             $(".elttocheck").attr("checked","true");
        });
        $('#toolsbar').on('click','#uncheckall',function(event){
             $(".elttocheck").removeAttr("checked");
        });
        
        $('#actionselect').change(function(){
            var val = $('#actionselect option:selected').val();
            if(val !=""){
         ...
         $('#btnsearchzone').click(function(e){
                 submitForm();
         });
         
         $("#searchzone").focus(function(){
			if($("#searchzone").val()== "recherche"){
				$("#searchzone").val("");
			}
		});
		$("#searchzone").blur(function(){
			if($("#searchzone").val()== ""){
				$("#searchzone").val("recherche");
			}
		});
